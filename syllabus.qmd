...
Collaboration within the class (including across class sections) is both allowed and encouraged on homework assignments, subject to certain conditions outlined in the paragraph below. Students collaborating with a group are expected to prepare their own solutions, in their own words and writing, and are required to indicate their collaborators in writing on their submission. Submissions that do not indicate any collaborators will be understood to represent the sole and independent effort of the student named on the submission.

A collaboration requires that all parties make material contributions to a shared work. Material contributions might include participation in discussions, suggesting an approach or idea, providing consultation on a problem or difficulty, or presenting an approach. In short, there must be shared effort among each student involved. While the end result of a homework collaboration may be a set of shared answers, the converse is not true: a set of shared answers is not necessarily the result of a collaboration. A set of submissions containing common answers resulting from exchange does not reflect a legitimate collaboration unless each individual contributed materially to the result. In that respect, collaboration does not include directly requesting or distributing answers, consulting with students or other individuals outside of the class, dividing an assignment among a group and exchanging answers, or sitting in on a group work session without actively participating. Any instances of unacknowledged or inappropriate exchange of work will be regarded as acts of academic disohonesty. The best way to ensure that a group effort is consistent with this collaboration policy is to agree that all team members will attempt all or most of each assignment individually before engaging in any discussion or exchange.

#### Attendance

Regular attendance is essential for success in the course and required per University policy. Each student may miss two class meetings without notice but subsequent absences should be [excusable](https://academicprograms.calpoly.edu/content/academicpolicies/class-attendance). Unexcused absences may negatively impact course grades.
