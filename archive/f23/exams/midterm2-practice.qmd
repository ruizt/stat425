...
#       - text:
#           \pagestyle{fancy}
#           \fancyhead[LH]{Midterm 2 Practice}
...
1.  Let $f(x) = c\left[1 - (x - 1)^2\right]$. Find the value of $c$ and support set for which $f$ is a PDF.
...
3. Let $X \sim \text{exponential}(\beta)$ and $c > 0$ and define $$
    Y = \begin{cases}
      1 &,\; X > c \\
      0 &,\; X \leq c
    \end{cases}
