...
(Technically, such a collection is known as a "$\sigma$-algebra" of sets. These can be generated in a variety of ways; we won't go into the details here. Broadly, this construction is used to obtain a subcollection of $2^S$ with some essential regularity properties. Notice the possibility that there are subsets of $S$ that are not events.)
